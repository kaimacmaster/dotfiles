...
if [ -f ~/dotfiles/scripts/bash_functions.sh ]; then
    . ~/dotfiles/scripts/bash_functions.sh
fi

if [ -f ~/dotfiles/scripts/bash_aliases.sh ]; then
    . ~/dotfiles/scripts/bash_aliases.sh
fi
